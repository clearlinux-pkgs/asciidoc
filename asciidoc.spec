...
Source0  : https://files.pythonhosted.org/packages/1d/e7/315a82f2d256e9270977aa3c15e8fe281fd7c40b8e2a0b97e0cb61ca8fa0/asciidoc-10.2.1.tar.gz
...
%prep
%setup -q -n asciidoc-10.2.1
cd %{_builddir}/asciidoc-10.2.1
pushd ..
cp -a asciidoc-10.2.1 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1721239998
...
cp %{_builddir}/asciidoc-%{version}/LICENSE %{buildroot}/usr/share/package-licenses/asciidoc/4cc77b90af91e615a64ae04893fdffa7939db84c || :
...
/usr/share/package-licenses/asciidoc/4cc77b90af91e615a64ae04893fdffa7939db84c
