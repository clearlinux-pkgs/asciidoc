...
Version  : 9.1.1
Release  : 48
URL      : https://github.com/asciidoc-py/asciidoc-py/releases/download/9.1.1/asciidoc-9.1.1.tar.gz
Source0  : https://github.com/asciidoc-py/asciidoc-py/releases/download/9.1.1/asciidoc-9.1.1.tar.gz
...
%prep
%setup -q -n asciidoc-9.1.1
cd %{_builddir}/asciidoc-9.1.1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1632158700
...
cp %{_builddir}/asciidoc-9.1.1/COPYRIGHT %{buildroot}/usr/share/package-licenses/asciidoc/2410a431538d037cf19c5b43b49dffee29d3d8f2
%make_install
